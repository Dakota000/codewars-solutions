...
function zombie_shootout(zombies, range, ammo){
    ...
    return ammo < steps && zombies > ammo ? `You shot ${ammo} zombies before being eaten: ran out of ammo.` :
           ammo < steps && zombies > ammo ? `You shot ${ammo} zombies before being eaten: ran out of ammo.` :
           zombies > steps ? `You shot ${steps} zombies before being eaten: overwhelmed.` :
